                    ...
                    <div className=''>
                        ...
                        <div className="row mt-5  align-items-center">
                            ...
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'>Open-air baths</h1>
                        ...
                        <div className="row mt-5  align-items-center">
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'>Cypress bath (female area only)</h1>
                        ...
                        <div className="row mt-5  align-items-center">
                            ...
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'>Pottery bath</h1>
                        ...
                        <div className="row mt-5  align-items-center">
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'>Indoor bath</h1>
                        ...
                        <div className="row mt-5  align-items-center">
                            ...
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'>Reserved private room with baths</h1>
                        ...
                        <div className="row mt-5  align-items-center">
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'>Saunas</h1>
                        ...
                        <div className="row mt-5  align-items-center">
                            ...
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'>Lie down bath</h1>
