                    ...
                    <div className=''>
                        ...
                        <div className="row mt-5  align-items-center">
                            ...
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'><span className='dark-blue'>Aegean Sea</span> of Gods</h1>
                        ...
                        <div className="row mt-5  align-items-center">
                            ...
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'><span className='dark-blue'>Coffee</span> bath</h1>
                        ...
                        <div className="row mt-5  align-items-center">
                            ...
                            <div className="col-12 col-lg-5 p-4">
                                <h1 className='pacifico-font'><span className='dark-blue'>Splish-Splash</span> pool</h1>
