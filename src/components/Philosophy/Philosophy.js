            ...
            <div className='container'>
                ...
                <div className='row text-center  py-5 '>
                    <div className=' col-12 col-md-6 col-lg-4 p-3 '>
                        ...
                        <span>All cosmetic forumulas are organic.</span>
                        <br />
                        <span>The majority of all ingredients is</span>
                        <br />
                        <span>natural.</span>
                    </div>
                    <div className=' col-12 col-md-6 col-lg-4 p-3 '>
                        ...
                        <span>Even nowadays some cosmetic</span>
                        <br />
                        <span>products are tested on animals. That</span>
                        <br />
                        <span>is not the case for us.</span>
                        <br />
                    </div>
                    <div className=' col-12 col-md-6 col-lg-4 p-3 '>
                        <img src={require('../../images/philosophy-icons/3.png')} className='img-fluid' width='60' alt="" />
                        <h6 className='py-3'>Professional Care</h6>
                        <span>All products we use are professional</span>
                        <br />
                        <span>and have proven effeciency. No</span>
                        <br />
                    ...
                    <div className=' col-12 col-md-6 col-lg-4 p-3 '>
                        ...
                        <span>Don’t worry, all our nails polishes and</span>
                        <br />
                        <span>other products are non-toxic. We do</span>
                        <br />
                        <span>care about you and our specialists.</span>
                    </div>
                    <div className=' col-12 col-md-6 col-lg-4 p-3 '>
                        ...
                        <span>Each guest is our favourite guest.</span>
                        <br />
                        <span>Come and make sure that our service</span>
                        <br />
                        <span>is exceptional.</span>
                    </div>
                    <div className=' col-12 col-md-6 col-lg-4 p-3 '>
                        <img src={require('../../images/philosophy-icons/6.png')} className='img-fluid' width='60' alt="" />
                        <h6 className='py-3'>We Love What We Do</h6>
                        <span>People that you’ll meet in our studio</span>
                        <br />
                        <span>are doing job they love. Come and</span>
                        <br />
                        <span>make sure there is a difference.</span>
                    </div>
            ...
            <section className='container'>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-12 col-md-5 px-5">
                        ...
                        <p>Dear friends, I would certainly love to meet you all in persone, so come and just say hi. If it’s not possible at the moment, I would loke to introduce myself‚ I’m Shafin, the founder of Yamashiro Onsen. I’m certain that new haircut, professional makup or just getting your nails done — is a pretty easy way to make your day or week better. I guarantee that you will appreciate the atmosphere of our place. Looking forward to meeting you!</p>
